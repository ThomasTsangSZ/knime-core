...
import org.knime.core.data.store.column.partition.therealstore.PartitionCacheLoader;

public final class ArrowVectorFromDiskLoader<V extends FieldVector> implements PartitionCacheLoader<V>, AutoCloseable {
	...
	@Override
	public V loadPartition(final long index) throws IOException {
