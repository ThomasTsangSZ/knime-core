...
public final class ArrowVectorToDiskFlusher<V extends FieldVector> implements PartitionCacheFlusher<V>, AutoCloseable {
	...
	@Override
	public void flushPartition(final V vector) throws IOException {
