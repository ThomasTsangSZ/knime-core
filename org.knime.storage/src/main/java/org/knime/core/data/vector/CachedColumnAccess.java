...
//
//import org.knime.core.data.store.ColumnPartitionReader;
...
//	}
//
//	private CachedColumnPartition add(long partitionIndex, final Data<T> partition) {
...
//	 */
//	@Override
//	public synchronized void write(Data<T> partition) throws IOException {
...
//
//	@Override
//	public synchronized Data<T> createPartition() {
...
//	private class CachedColumnPartition implements Data<T> {
//		private final Data<T> m_partitionDelegate;
//		private int m_numValues;
//		private AtomicInteger m_lock;
//
//		public CachedColumnPartition(Data<T> delegate) {
...
//			return m_partitionDelegate.getData();
//		}
//
//		@Override
