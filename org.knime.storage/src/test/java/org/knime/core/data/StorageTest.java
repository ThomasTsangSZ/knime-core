...
public class StorageTest {
	...
	private static final int BATCH_SIZE = RootAllocator.nextPowerOfTwo(32);
	...
	public void columnwiseWriteReadStructColumnIdentityTest() throws Exception {
		try (final RootStore root = ArrowUtils.createArrowStore(OFFHEAP_SIZE, BATCH_SIZE, STRUCT_SCHEMA)) {
